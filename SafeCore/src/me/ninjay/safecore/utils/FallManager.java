...
public class FallManager extends EventsManager {
	...
	/**
	 * Alterador de evento, que ao jogador cair e estiver na lista nao cancela o
	 * dano
	 * 
	 * @param event
	 *            Entidade toma dano Evento
	 */
	@EventHandler
	...
	/**
	 * Manipulador de evento, que quando o jogador estiver no ch§o e n§o estiver
	 * caindo remove da lista
	 * 
	 * @param event
	 *            Jogador anda evento
	 */
