...
public class PlayerClickEntity extends PlayerInteract {
	...
	public PlayerClickEntity(ItemStack item, PlayerClickEntityEffect clickEntityEffect) {
		this(item);
		setClickEntityEffect(clickEntityEffect);
	}

	public PlayerClickEntity(Material material, PlayerClickEntityEffect clickEntityEffect) {
	...
	public void onClickAtEntity(PlayerInteractEntityEvent event) {
		...
		if (!isInteractWithAnyItem()) {
			if (!getItemComparationType().compare(getItem(), event.getPlayer().getItemInHand()))
				return;
		}
		clickEntityEffect.onClickAtEntity(player, event.getRightClicked(), getItem());
	...
	public void setClickEntityEffect(PlayerClickEntityEffect clickEntityEffect) {
