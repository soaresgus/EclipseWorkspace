...
public class EstruturaAdmin {
	...
	public static void ajudastf(Player p ) {
		p.sendMessage("§e§lMvP Comandos\n \n§e§l/mvp entrar §eEntre no evento.\n \n§e§l/mvp iniciar §eInicie o evento.\n \n§e§l/mvp setspawn §eSeta o spawn do evento.\n \n§e§l/mvp setjogo §eSeta o local onde irá ocorrer o evento.\n \n§e§l/mvp setmorte §eSeta o local no qual o jogador irá nascer se morrer no evento.\n \n§e§l/mvp setmob<1/2/3> §eSeta os locais aonde irá spawnar os mobs.");
	}
