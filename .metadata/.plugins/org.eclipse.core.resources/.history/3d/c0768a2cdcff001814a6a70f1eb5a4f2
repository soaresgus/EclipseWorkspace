...
public class EstruturaJogador {
	...
	public static void mercadoNegro(Player p, Inventory menu, ItemStack item1,int slotItem1, ItemStack item2,int slotItem2, ItemStack item3,int slotItem3, ItemStack item4,int slotItem4, ItemStack item5,int slotItem5) {
