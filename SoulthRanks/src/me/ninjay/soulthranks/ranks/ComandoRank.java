...
public class ComandoRank implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String a, String[] args) {
		if (sender instanceof Player) {
			...
			//Cold/Dark/Flight/Souls/Killer/Demo/Dingy/‘mega - ranks
			...
			ranks2.setItem(Mine.getPosition(5, 5), omega3);
			ranks2.setItem(Mine.getPosition(5, 5), omega2);
			ranks2.setItem(Mine.getPosition(5, 5), omega1);
